...
| TEST-SEC-004 | Evidence and validation records are tamper-aware. | NFR-002, NFR-003 | TASK-0033, TASK-0034 | DM-012, DM-006 | AC-007, AC-003 | Evidence registration must include path/checksum/producer/summary in TASK-0034. | Planned |
...
| SEC-BLOCK-002 | Evidence registration does not yet include checksum capture through CLI. | TASK-0034 | Open |
