...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TEST-SEC-001 | Configuration and secret handling are documented and not committed. | NFR-003, NFR-004 | TASK-0024, TASK-0025, TASK-0035 | DM-006, BC-003 | AC-003 | Inspect `.env.example`, generated docs, and `wiki/deployment/secrets-management.md`. | Planned |
...
| TEST-SEC-003 | Architecture security model exists before release. | NFR-003, REQ-003 | TASK-0018, TASK-0020, TASK-0036 | DM-006, BC-201 | AC-004 | Run `python3 tools/echel.py readiness --stage architecture` and `python3 tools/echel.py readiness --stage release`. | Planned |
