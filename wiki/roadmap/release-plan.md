...
The release plan defines the milestone path implied by the roadmap. TASK-0035 added the deployment artifact surface, TASK-0036 added the release readiness gate for validation, evidence, deployment, rollback, secrets, risks, and blockers, TASK-0037 added the operations artifact surface for support handoff and post-release evolution, and TASK-0038 added routed learning-loop capture. This document keeps the roadmap honest about what can be demonstrated, verified, and released at each milestone.
...
| REL-003 | Agent Task Release | Make individual tasks safe for one implementation session. | Upgraded task generation and task templates. | REL-002, TASK-0023 | One task packet can be handed to an implementation agent. | Task packet misses tests or rollback. | Generated task includes all required fields and validation command. | RM-003, TASK-0023 | Done |
| REL-004 | Repository Factory Release | Produce a runnable generated repository baseline. | App/config/test/CI/env skeleton and engineering docs. | REL-003, TASK-0024, TASK-0025 | Generated repo sets up, starts, and runs tests/lint. | Skeleton cannot be verified locally. | Local development docs and verification commands pass. | RM-004, TASK-0024, TASK-0025 | Done |
| REL-005 | Traceability Release | Make lifecycle traceability visible and auditable. | Agent roles/playbooks/handoff plus graph and traceability matrix upgrades. | REL-004, TASK-0026..TASK-0031 | Traceability report identifies complete and broken chains. | Graph metadata creates migration churn. | Graph validation passes and matrix report exists. | RM-005, TASK-0026..TASK-0031 | Done |
...
- Do not call a roadmap release production-ready until validation, evidence, deployment, rollback, release-gate, operations artifacts, and routed learning-loop handoff exist.
