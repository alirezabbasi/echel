...
| EP3-003 | Add evidence registration | Let agents register evidence without hand-editing JSON. | Task closure and release proof need durable evidence records. | `echel evidence add` flow. | EP3-002, TASK-0034 | Evidence includes subject, kind, path, checksum, producer, summary. | Unit tests and registry validation | `python3 tools/echel.py doctor` | Update evidence docs. | Evidence command/tests/docs. | Planned |
