...
| TASK-1018 ([[TASK-1018-add-governance-integrity-artifacts]]) | EP4-003 | Add governance integrity artifacts | `execution/phase-4-evolution.md` | TASK-0041, TASK-0042, TASK-0043 | `python3 tools/echel.py doctor` | Active |
