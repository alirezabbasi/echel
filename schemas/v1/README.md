...
`record.schema.json` is the authoritative structural contract for Echel 2's twelve
canonical record types. Validate records through `echel.schemas.SchemaRegistry` so
