...
- [ ] TASK-1019 Preserve migration compatibility (TASK-0044 done; TASK-0045/TASK-0046 pending)
...
- [x] TASK-0007 Interactive clarification flow
- [x] TASK-0008 Product-first wiki template cleanup
- [x] TASK-0009 MVP planning synthesis
- [x] TASK-0010 Agent work packet generation
