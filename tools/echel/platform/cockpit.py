...
SAFE_COMMANDS = {
    ...
    "contradictions-sync": ["contradictions", "sync"],
    ...
    specs = [
        ...
        },
        {
            ...
            "safe_actions": [
                ...
                {"label": "Sync Contradictions", "action": "contradictions-sync", "args": {}, "description": "Promote local contradiction memory into the governance register."},
                {"label": "Migration Compatibility", "action": "migration-compatibility", "args": {}, "description": "Refresh legacy root-page compatibility mapping."},
